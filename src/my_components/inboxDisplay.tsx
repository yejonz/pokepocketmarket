...
export default function InboxDisplay({ data, deleteReq }: { data: ReqData; deleteReq: (docRef: DocumentReference<DocumentData, DocumentData>) => void }) {
  return (
    <div className="m-4">
      <Card className="flex p-4 relative">
        ...
        <div className="flex flex-col">
          <h3 className="text-xl font-mono font-semibold mb-4 mt-2 ml-4">You have:</h3>
        ...
        <div className="flex flex-col">
          <h3 className="text-xl font-mono font-semibold mb-4 mt-2 ml-4">You want:</h3>
          <div className="max-w-[294px] m-1 w-48">
